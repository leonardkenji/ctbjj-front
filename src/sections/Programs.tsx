export const Programs = () => {
  return (
    <section className="px-8 py-8">
      <div className="font-black text-5xl py-5 pb-10">
        <h2> PROGRAMAS </h2>
      </div>
      <div className="container px-5">
        <div className="p-5 bg-neutral-primary-soft block max-w-sm border border-default rounded shadow-xs">
            <a href="#">
                <img className="rounded" src="../src/assets/ctbjj-kids.png" alt="" />
            </a>
            <div className="p-6 text-center flex flex-wrap gap-3 items-center justify-center  ">
                ...
                <a href="#">
                    <h5 className="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading">Jiu Jitsu Kids</h5>
                </a>
            </div>
        </div>
      </div>
